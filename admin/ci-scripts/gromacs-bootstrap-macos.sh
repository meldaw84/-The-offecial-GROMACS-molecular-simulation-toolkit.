...
if [ -f "${PREFIX}/include/omp.h" ] && [ -f "${PREFIX}/lib/libomp.a" ] && [ -f "${PREFIX}/lib/libomp.dylib" ]; then
...
if [ -f "${PREFIX}/lib/libfftw3f.a" ] && [ -f "${PREFIX}/lib/libfftw3f.dylib" ] && [ -f "${PREFIX}/include/fftw3.h" ]; then
