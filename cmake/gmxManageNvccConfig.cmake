...
if (GMX_CUDA_TARGET_SM OR GMX_CUDA_TARGET_COMPUTE)
    ...
    foreach(_target ${_target_sm_list})
        if (NOT ${_target} MATCHES "^[1-9][0-9]\+$")
            message(WARNING "Your choice of ${_target} in GMX_CUDA_TARGET_SM appears to be invalid. Please, use only numbers (e.g., \"72\" for CC 7.2)")
        endif()
    ...
    foreach(_target ${_target_compute_list})
        if (NOT ${_target} MATCHES "^[1-9][0-9]\+$")
            message(WARNING "Your choice of ${_target} in GMX_CUDA_TARGET_COMPUTE appears to be invalid. Please, use only numbers (e.g., \"72\" for CC 7.2)")
        endif()
