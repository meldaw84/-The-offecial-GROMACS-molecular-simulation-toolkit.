...
mark_as_advanced( CMAKE_CXX_FLAGS_REFERENCE CMAKE_EXE_LINKER_FLAGS_REFERENCE)
...
if("${CMAKE_BUILD_TYPE}" STREQUAL "Reference")
    ...
    if(NOT "${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU" OR "${CMAKE_CXX_COMPILER_VERSION}" VERSION_GREATER_EQUAL "8")
        message(WARNING "Reference values for regressiontests should use GROMACS compiled with "
            "gcc 7.x, but your configuration is using ${CMAKE_CXX_COMPILER_ID}-${CMAKE_CXX_COMPILER_VERSION}.")
    endif()
endif()
