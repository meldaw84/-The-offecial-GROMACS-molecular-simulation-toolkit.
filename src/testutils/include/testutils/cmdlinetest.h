...
public:
     ...
     */
    std::filesystem::path setOutputFile(CommandLine*                     args,
                                        const char*                      option,
                                        const std::filesystem::path&     filename,
                                        const ITextBlockMatcherSettings& matcher);
    //! \copydoc setOutputFile(CommandLine *, const char *, const std::filesystem::path &, const ITextBlockMatcherSettings &)
    std::filesystem::path setOutputFile(CommandLine*                 args,
                                        const char*                  option,
                                        const std::filesystem::path& filename,
    ...
    std::filesystem::path setOutputFileWithGeneratedName(const std::filesystem::path&     filename,
                                                         const ITextBlockMatcherSettings& matcher);
    //! \copydoc setOutputFileWithGeneratedName(const std::filesystem::path &, const ITextBlockMatcherSettings &)
    std::filesystem::path setOutputFileWithGeneratedName(const std::filesystem::path& filename,
                                                         const IFileMatcherSettings&  matcher);
...
public:
     ...
     */
    void setInputFile(const char* option, const std::filesystem::path& filename);
    /*! \brief
     ...
     *
     */
    void setModifiableInputFile(const char* option, const std::filesystem::path& filename);
    /*! \brief
     * Generates and sets an input file.
     *
     ...
     */
    std::filesystem::path setOutputFile(const char*                      option,
                                        const std::filesystem::path&     filename,
                                        const ITextBlockMatcherSettings& matcher);
    //! \copydoc setOutputFile(const std::filesystem::path &, const ITextBlockMatcherSettings &)
    std::filesystem::path setOutputFile(const char*                  option,
                                        const std::filesystem::path& filename,
                                        const IFileMatcherSettings&  matcher);
    /*! \brief
     ...
     */
    std::filesystem::path setInputAndOutputFile(const char*                      option,
                                                const std::filesystem::path&     filename,
                                                const ITextBlockMatcherSettings& matcher);
    //! \copydoc setInputAndOutputFile(const char *, const std::filesystem::path &, const ITextBlockMatcherSettings&);
    std::filesystem::path setInputAndOutputFile(const char*                  option,
                                                const std::filesystem::path& filename,
                                                const IFileMatcherSettings&  matcher);
