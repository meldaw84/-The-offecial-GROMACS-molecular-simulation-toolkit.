...
const uint32_t rangeColors[] = { 0xff00ff00, 0xff0000ff, 0xffffff00, 0xffff00ff, 0xff00ffff, 0xffff0000, 0xffffffff };
const int numColors = sizeof(rangeColors)/sizeof(uint32_t);

const uint32_t subRangeColors[] = { 0x9900ff00, 0x990000ff, 0x99ffff00, 0x99ff00ff, 0x9900ffff, 0x99ff0000, 0x99ffffff };
