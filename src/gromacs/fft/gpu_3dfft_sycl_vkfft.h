...
/*! \internal \file
 *  \brief Declares the GPU 3D FFT routines for VkFFT.
 *
...
public:
    ...
    ImplSyclVkfft(bool                 allocateRealGrid,
                  MPI_Comm             comm,
...
private:
    ...
    static Descriptor initDescriptor(const ivec realGridSize);
        */
        ...
        std::array<uint64_t, DIM> inputBufferSize_;
        //std::array<uint64_t, DIM> bufferSize_;
};
