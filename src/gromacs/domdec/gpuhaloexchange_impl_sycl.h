...
/*! \internal \file
 *
 * \brief Declares SYCL implementation of GPU Halo Exchange.
 *
 ...
 */
#ifndef GMX_DOMDEC_GPUHALOEXCHANGE_IMPL_SYCL_H
#define GMX_DOMDEC_GPUHALOEXCHANGE_IMPL_SYCL_H
...
private:
    ...
    /*! \brief Data transfer for GPU halo exchange using SYCL memcopies
     ...
     */
    void communicateHaloDataWithSyclDirect(Float3* sendPtr, int sendSize, int sendRank, Float3* remotePtr, int recvRank);
     ...
     * \param [in] recvRank     rank of source
     */
    void communicateHaloDataWithSyclMpi(Float3* sendPtr,
                                        int     sendSize,
                                        int     sendRank,
                                        Float3* recvPtr,
                                        int     recvSize,
...
#endif // GMX_DOMDEC_GPUHALOEXCHANGE_IMPL_SYCL_H
