...
static sycl::property_list makeQueuePropertyList(bool inOrder, bool enableProfiling, DeviceStreamPriority priority)
{
    ...
    {
        return { sycl::property::queue::hipSYCL_coarse_grained_events{},sycl::property::queue::hipSYCL_priority{prioirtyLevel} ,  sycl::property::queue::in_order(), sycl::property::queue::enable_profiling() };
    }
    else if (enableProfiling && !inOrder)
    {
        return { sycl::property::queue::hipSYCL_coarse_grained_events{},sycl::property::queue::hipSYCL_priority{prioirtyLevel} ,  sycl::property::queue::enable_profiling() };
    }
    else if (!enableProfiling && inOrder)
    {
        return { sycl::property::queue::hipSYCL_coarse_grained_events{},sycl::property::queue::hipSYCL_priority{prioirtyLevel} ,  sycl::property::queue::in_order() };
    }
    else
    {
        return {sycl::property::queue::hipSYCL_coarse_grained_events{},sycl::property::queue::hipSYCL_priority{prioirtyLevel}  };
    }
}
