...
static bool hasPerturbedCharge(int atom, gmx::ArrayRef<const std::int64_t> atomInfo)
{
...
void gmx_sort_ilist_fe(InteractionDefinitions* idef, gmx::ArrayRef<const std::int64_t> atomInfo)
{
