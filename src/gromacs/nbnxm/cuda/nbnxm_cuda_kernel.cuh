...
#    ifdef EXCLUSION_FORCES
    ...
    __builtin_assume(nonSelfInteraction >= 0); 
#    endif
    ...
    {
        __builtin_assume(j4 >= 0); 
        int wexcl_idx = pl_cj4[j4].imei[widx].excl_ind;
        __builtin_assume(wexcl_idx >= 0); 
...
#    ifndef LJ_COMB
                                /* LJ 6*C6 and 12*C12 */
                                int typei = atib[i * c_clSize + tidxi];
