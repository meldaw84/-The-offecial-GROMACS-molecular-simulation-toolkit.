 ...
 * GMX_NBNXN_SIMD_8XN, so that this file reduces to a stub
...
#endif /* GMX_NBNXN_SIMD_8XN */

#ifdef CALC_ENERGIES
void
nbnxm_kernel_ElecQSTabTwinCut_VdwLJEwCombGeom_VgrpF_8xm(const NbnxnPairlistCpu    gmx_unused *nbl,
