                                                                     ...
                                                                     const nbnxn_atomdata_t& atomdata)
{
    ...
    else if (pairlistType == PairlistType::Simple2x16)
    {
#if GMX_SIMD && GMX_SIMD_REAL_WIDTH == 16
        return ClusterDistanceKernelType::CpuSimd_2xM;
#else
        GMX_RELEASE_ASSERT(false, "Expect 16-wide SIMD with 2x16 list and nbat SIMD layout");
#endif
    }
