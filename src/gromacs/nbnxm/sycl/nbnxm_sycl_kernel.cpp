 ...
 *
 * Intel iGPUs without native floating-point operations emulate them via CAS-loop,
                        ...
                        const bool                                                  calcShift)
{
    ...
    constexpr bool useShuffleReductionForceI =
            (subGroupSize % c_clSize == 0) && (gmx::StaticLog2<subGroupSize / c_clSize>::value <= 3)
            && (c_clSize == 8 || c_clSize == 4) && !c_avoidFloatingPointAtomics;
