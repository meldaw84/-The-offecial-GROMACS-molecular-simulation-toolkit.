 ...
 *
 * The only thing not covered is LJ-PME with Lorentz-Berthelot combination rule,
 * as this is only implemented in the plain-C reference kernel and currently
 * the reference data is generated by the SIMD kernels.
 *
