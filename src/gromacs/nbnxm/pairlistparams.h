 ...
 */
#if ! defined GMX_NBNXM_CLUSTER_PAIR_SPLIT
#   define GMX_NBNXM_CLUSTER_PAIR_SPLIT 1
#endif
static constexpr int c_nbnxnGpuClusterpairSplit = GMX_NBNXM_CLUSTER_PAIR_SPLIT;
