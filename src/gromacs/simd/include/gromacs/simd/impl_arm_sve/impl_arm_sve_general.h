...
#define SVE_SIMD_FLOAT_HALF_DOUBLE_MASK svwhilelt_b32(0, (std::int32_t)GMX_SIMD_DINT32_WIDTH)
#define SVE_SIMD_DOUBLE_HALF_MASK svwhilelt_b64(0, (std::int32_t)GMX_SIMD_DOUBLE_WIDTH / 2)
