 ...
 *
 * Sets the masses of atoms with mass smaller than the smallest atom mass
 * in the system to the smallest mass times massFactor. The additional mass
 * is taken away from the atom bound to the light atom.
 ...
 * lighter than the smallest mss times massFactor.
 *
