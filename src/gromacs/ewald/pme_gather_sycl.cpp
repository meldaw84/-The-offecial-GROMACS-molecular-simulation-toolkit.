...
auto pmeGatherKernel(sycl::handler&                                     cgh,
                     ...
                     DeviceAccessor<Float3, mode::write>                a_forces,
                     OptionalAccessor<float, mode::read, readGlobal>    a_theta,
                     OptionalAccessor<float, mode::read, readGlobal>    a_dtheta,
                     OptionalAccessor<int, mode::read, readGlobal>      a_gridlineIndices,
