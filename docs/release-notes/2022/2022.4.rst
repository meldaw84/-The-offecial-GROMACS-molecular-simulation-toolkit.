...
Support only one version of muParser
"""""""""""""""""""""""""""""""""""""""""""""""""""

Recent changes in the API between minor versions of muParser meant that building |Gromacs| with these versions
would fail due to linking errors for undefined symbols. Now when using an external muParser library, |Gromacs|
requires the same version as the bundled one.
