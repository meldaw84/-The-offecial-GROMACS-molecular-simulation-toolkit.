...
at regular intervals in order to avoid (too) large velocities. Note that virtual
site velocities are only used for output, they do not affect the positions.
