...
Virtual site velocities were only updated when writing velocities, but they were
used for integration. This could make simulations crash. Now the velocities are updated
at regular intervals in order to avoid instabilities (LINCS errors).
